...
try:
    ...
    print("⚠️ Surprise library not available. SVD baseline will be skipped.")
...
try:
    ...
    print("⚠️ LightFM library not available. LightFM baseline will be skipped.")
...
try:
    ...
    print("⚠️ CaseRecommender library not available. UserKNN and UserFM baselines will be skipped.")
...
try:
    ...
    print("⚠️ xLearn library not available. CARSFM baseline will be skipped.")
...
class CVCPRBaselineEvaluator:
    ...
    def evaluate_svd_surprise(self):
        ...
        if not SURPRISE_AVAILABLE:
            print("\n⚠️ Skipping SVD - Surprise library not available")
            return None, None
    ...
    def evaluate_lightfm(self):
        ...
        if not LIGHTFM_AVAILABLE:
            print("\n⚠️ Skipping LightFM - LightFM library not available")
            return None, None
    ...
    def evaluate_caserec_methods(self):
        ...
        if not CASEREC_AVAILABLE:
            print("\n⚠️ Skipping CaseRecommender methods - library not available")
        ...
        def evaluate_predictions(predictions, model_name):
            if not predictions:
                print(f"\n⚠️ No predictions available for {model_name}")
                return None, None
            ...
            if num_cols == 4:
                ...
                print(f"⚠️ Unexpected prediction format with {num_cols} columns!")
                return None, None
    ...
    def evaluate_carsfm_xlearn(self):
        ...
        if not XLEARN_AVAILABLE:
            print("\n⚠️ Skipping CARSFM - xLearn library not available")
            return None, None
